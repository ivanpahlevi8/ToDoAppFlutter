...
class DisconnectConnectionByuserItemShimmer extends StatelessWidget {
  const DisconnectConnectionByuserItemShimmer({super.key});
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            ...
            customColor.timeLineCardColor6!.withOpacity(0.8),
          ],
